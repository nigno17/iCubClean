...
void CtrlThread::run() {
    ...
    if (yarpImage!=NULL) {
        ...
        inputQuad2[0] = cv::Point2f(            88,             102);
        inputQuad2[1] = cv::Point2f(           228,              88);
        inputQuad2[2] = cv::Point2f(            97,             172);
        inputQuad2[3] = cv::Point2f(           228,             163);


	outputQuad2[0] = cv::Point2f(          100,             120);
        outputQuad2[1] = cv::Point2f(          220,             120);
        outputQuad2[2] = cv::Point2f(          100,             180);
        outputQuad2[3] = cv::Point2f(          220,             180);
