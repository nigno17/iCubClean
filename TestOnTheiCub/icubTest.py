...
for loop in range(20):
    ...
    iMode = armDriver_left.viewIControlMode()
    for j in range(jnts):
        iMode.setPositionMode(j)
...
#    o_init.set(3, o[3])
    ...
    icart_left.goToPoseSync(x_init, o_init)
    
    done=False
    while done == False:
       done = icart_left.checkMotionDone()
       time.sleep(0.01)
    ...
    for traj_it in traj[1:]:
        ...
        icart_left.goToPose(x_init, o_init)
        time.sleep(0.01)
